...
read -p "svn password(leave empty if not have): " svn_password
cd $svn_path;
...
wget -P ~/.script https://github.com/chenhuanjie/sources/releases/download/0.0.5/svn_update_checker.sh;
